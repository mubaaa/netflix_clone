...
//now playing
class NowPlat extends StatefulWidget {
   final int ind;
  const NowPlat({ Key? key, required this.ind }) : super(key: key);

  @override
  State<NowPlat> createState() => _NowPlatState();
}

class _NowPlatState extends State<NowPlat> {
  @override
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FutureBuilder(
              ...
              builder: ((BuildContext context, AsyncSnapshot<NowPlaying?> snapshot) {
                if (snapshot.hasData) {
